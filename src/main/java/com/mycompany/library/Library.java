 ...
 public Library() {
   ...
   public void removeLoanBook(int index)
   {
    ...
    String m = "The Menu:"
            ...
            + "3- cheek the number of book in the libraby"
            ...
            + "8- add information abut Studant"
            + "9 - remove Studant"
            + "10- add Magazine"
            + "11 add journal"
            + "12- Search a book from it name or it no or it Author Name"
            + "13- Exit";
    do 
    {
    ...
    switch (x)
    {
        ...
        case 5:
           ...
           if(l1.cheek(s1, s2))
           {
               System.out.println("Enter how many book the studant is take");
               int dd3 = scan.nextInt();
               for (int i=0;i<=dd3;i++)
            {
               l1.printLoanBook();
        ...
        case 7:
           ...
           System.out.println(l1.SearchTheExactBook(b5));
            break;
        case 8:
